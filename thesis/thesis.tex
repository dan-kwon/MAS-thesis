...
\section{Methodology}
To test the effects that synthetic images have on image classifcation performance, we tested different combinations of 
model architectures paired with image augmentation techniques. Our models were also trained on different ratios of real 
and synthetic images in order to observe how synthetic images affect performance. Each combination is trained 20 times 
