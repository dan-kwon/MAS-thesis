...
\begin{tabular}{ |p{5cm}||p{3.5cm}|p{3.5cm}|p{3.5cm}|  }
    ...
    \hline
    \makecell{100\% Real / 0\% Synthetic}  & 0.113512 & 0.173663 & 0.15266 \\
    \makecell{80\% Real / 0\% Synthetic}  & 0.23912 & 0.270616 & 0.274309 \\
    \makecell{100\% Real / 20\% Synthetic \\ (Mild \& Moderate Demented Only) \\}  & 0.103296 & 0.169054 & 0.137484 \\
    \makecell{80\% Real / 20\% Synthetic \\ (Mild \& Moderate Demented Only) \\}  & 0.213611 & 0.247438 & 0.242083 \\
    \hline
\end{tabular}} \quad
\end{center}
